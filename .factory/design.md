...
- Display: locally hosted **Space Grotesk** (700), body: system sans stack. A mono system stack carries paths, commands, and evidence. This avoids external font traffic and keeps code dense.
